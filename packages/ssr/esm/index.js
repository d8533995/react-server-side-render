...
export default function getRender(_ref) {
  var App = _ref.App,
    routes = _ref.routes,
    reducers = _ref.reducers;
  return function (el) {
    var result = routes.find(function (i) {
      var matchInstance = match(i.path);
      return matchInstance(window.location.pathname);
    });
    var store = createStore(combineReducers(reducers), preloadedState);
    result.component().then(function (data) {
      ReactDOM.hydrate( /*#__PURE__*/React.createElement(App, null, /*#__PURE__*/React.createElement(Provider, {
        store: store
      }, /*#__PURE__*/React.createElement(BrowserRouter, null, /*#__PURE__*/React.createElement(Switch, null, routes.map(function (i) {
        if (result === i) {
          var Component = data.default;
          return /*#__PURE__*/React.createElement(Route, {
            path: i.path,
            key: i.path
          }, /*#__PURE__*/React.createElement(Component, null));
        } else {
          var _Component = /*#__PURE__*/React.lazy(i.component);
          ...
          }, /*#__PURE__*/React.createElement(_Component, null)));
        }
      }))))), el);
    });
  };
